...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateText(String strToAdd) {
        ...
        display.setText(String.format("%s%s%s", leftStr, strToAdd,rightStr)); //concatenate 2 numbers
        display.setSelection(cursorPos+strToAdd.length()); //move cursor

    }

    public void zeroBTNPush(View view) {
        updateText(getResources().getString(R.string.zeroText)); //from strings.xml
    }
    ...
    public void equalBTNPush(View view){
        ...
        display.setSelection(result.length());//cursor position is at the end
    }
